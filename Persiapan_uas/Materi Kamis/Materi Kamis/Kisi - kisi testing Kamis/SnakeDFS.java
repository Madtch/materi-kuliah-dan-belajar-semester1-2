...
public class SnakeDFS extends JPanel implements KeyListener {
    ...
    public SnakeDFS() {
        ...
        timer = new javax.swing.Timer(120, e -> gameLoop());
        timer.start();
    }
    ...
    void gameLoop() {
        ...
        // TABRAKAN = MATI
        if (!isSafe(nx, ny)) {
            JOptionPane.showMessageDialog(this, "Game Over (DFS)!");
            System.exit(0);
        }
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Snake DFS");
        frame.add(new SnakeDFS());
        frame.pack();
